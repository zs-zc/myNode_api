...
// 根据id获取文章
route.get("/cates/:id", expressJoi(get_cate_schema), artcateHandle.detailArtcate)

// 更新文章分类
route.post('/updatecate', expressJoi(update_cate_schema), artcateHandle.updateArtcate)
